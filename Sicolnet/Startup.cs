...
namespace Sicolnet
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string conexion = Encoding.UTF8.GetString(Convert.FromBase64String(Configuration.GetConnectionString("SicolnetConexion")));
            services.AddControllersWithViews();
            services.AddDbContext<SicolnetDBContext>(options => options.UseSqlServer(conexion));
